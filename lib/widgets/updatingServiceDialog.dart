...
import 'package:MCC/views/navpages/main_page%20copy.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  initialValue: ServiceCubit.arServiceName,
                              ...
                              Container(
                                width: double.infinity,
                                child: TextFormField(
                                  initialValue: ServiceCubit.enServiceName,
                                  textDirection: TextDirection.rtl,
                                  validator: (value) {
                                    if (value!.isNotEmpty) {
                              ...
                              Container(
                                width: double.infinity,
                                child: TextFormField(
                                  initialValue: ServiceCubit.ardescription,
                                  textDirection: TextDirection.rtl,
                                  validator: (value) {
                                    if (value!.isNotEmpty) {
                              ...
                              Container(
                                width: double.infinity,
                                child: TextFormField(
                                  initialValue: ServiceCubit.endescription,
                                  textDirection: TextDirection.rtl,
                                  validator: (value) {
                                    if (value!.isNotEmpty) {
                  ...
                  state is UpdatingServiceLoading? Center(child: 
                    SpinKitCircle(color: Colors.white30,),) :MyButton(
                      text: 'تعديل',
