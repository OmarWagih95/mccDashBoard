...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  void initState() {
    ...
    authCubit.timer = Timer.periodic(
        Duration(seconds: 6),
        (timer) => authCubit.checkEmailVerified(
            widget.email, widget.userName, widget.phoneNumber, widget.address));
  }
          ...
          body: Center(
              child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Image.asset('img/emailVerification.jpg'),
                      SizedBox(
                        height: 15.h,
                      ),
                      Text('check your inbox please for verification',
